    ...
    <main className="pt-20">
      ...
      <Section id="contact-info" title="연락처 정보">
        <div className="grid lg:grid-cols-3 gap-8">
          {/* 본사 */}
          <Reveal>
            <div className="p-8 rounded-2xl border border-gray-200 bg-gradient-to-br from-blue-500/10 to-cyan-500/10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">본사 및 영업본부</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">{contact.headquarters.address}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">{contact.headquarters.phone}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">{contact.headquarters.email}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">{contact.headquarters.hours}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* 고객센터 */}
          <Reveal delay={0.2}>
            <div className="p-8 rounded-2xl border border-gray-200 bg-gradient-to-br from-purple-500/10 to-violet-500/10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">A/S 및 기술지원</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">{contact.customerService.phone}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium">운영시간</div>
                    <div className="text-sm text-gray-600">{contact.customerService.hours}</div>
                  </div>
                </div>
              ...
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select className="w-full p-3 rounded-lg border border-gray-300 bg-white shadow-sm focus:border-cyan-400 focus:outline-none transition-colors">
                  ...
                  <div>
                    ...
                    <input 
                      type="text" 
                      className="w-full p-3 rounded-lg border border-gray-300 bg-white shadow-sm focus:border-cyan-400 focus:outline-none transition-colors"
        ...
        <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
                    {["에코쉬 EU-01", "Air Clean Care", "Dress Care", "기타"].map((product) => (
                      <label key={product} className="flex items-center gap-2 p-3 rounded-lg border border-gray-300 bg-white shadow-sm hover:bg-white/10 transition-colors cursor-pointer">
                ...
                <div>
                  ...
                  <textarea 
                    rows={6}
                    className="w-full p-3 rounded-lg border border-gray-300 bg-white shadow-sm focus:border-cyan-400 focus:outline-none transition-colors resize-none"
            ...
            {contact.partnership.programs.map((program, i) => (
              <Reveal key={i} delay={i * 0.1}>
                <button 
                  ...
                  className="p-6 rounded-xl border border-gray-200 bg-white shadow-sm text-center group hover:bg-white/10 transition-all w-full"
                >
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cyan-400/20 to-blue-400/20 border border-cyan-400/30 mx-auto mb-4 flex items-center justify-center">
                    {i === 0 && <Users className="text-green-600" size={24} />}
                    {i === 1 && <Building className="text-green-600" size={24} />}
                    {i === 2 && <Target className="text-green-600" size={24} />}
                    {i === 3 && <Globe className="text-green-600" size={24} />}
                  </div>
            ...
            <div className="p-8 rounded-2xl border border-gray-200 bg-gradient-to-br from-green-500/10 to-emerald-500/10">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {contact.partnership.benefits.map((benefit, i) => (
                  <div key={i} className="text-center p-4 rounded-xl border border-gray-200 bg-white shadow-sm">
      ...
      <Section id="quick-contact" title="빠른 연락" subtitle="긴급한 문의는 바로 연락하세요">
        <div className="grid md:grid-cols-3 gap-6">
          <Reveal>
            <a href={`tel:${contact.headquarters.phone}`} className="group p-6 rounded-xl border border-gray-200 bg-white shadow-sm hover:bg-white/10 transition-all block text-center">
              ...
              <p className="text-sm text-gray-600 mb-2">{contact.headquarters.phone}</p>
              <p className="text-xs text-foreground/60">{contact.headquarters.hours}</p>
            </a>
          </Reveal>
          
          <Reveal delay={0.1}>
            <a href={`mailto:${contact.headquarters.email}`} className="group p-6 rounded-xl border border-gray-200 bg-white shadow-sm hover:bg-white/10 transition-all block text-center">
              ...
              <p className="text-sm text-gray-600 mb-2">{contact.headquarters.email}</p>
